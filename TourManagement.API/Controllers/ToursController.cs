...
namespace TourManagement.API.Controllers
{
    ...
    public class ToursController : Controller
    {
        ...
        public async Task<IActionResult> AddYour([FromBody] TourForCreation tour)
        {
        ...
        [RequestHeaderMatchesMediaType("Content-Type", 
            new[] { "application/vnd.marvin.tourforcreation+json" })]
        public async Task<IActionResult> AddYourWithManager([FromBody] TourWithManagerForCreation tour)
        {
            if (tour == null) return BadRequest();
        }
        ...
        public async Task<IActionResult> AddSpecificTour<T>(T tour) where T : class
        {
            ...
            {
                tourEntity.ManagerId = new Guid("fec0a4d6-5830-4eb8-8024-272bd5d62bb");
            }
